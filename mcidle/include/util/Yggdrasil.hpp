...
class YggdrasilException : public std::exception
{
  ...
  public:
	...
	YggdrasilException(
		const std::string & error, const std::string & errorMessage) :
...
class Yggdrasil
{
  ...
  public:
	...
	const std::string & ClientToken() const { return m_ClientToken; }
	 ...
	 */
	bool JoinServer(
		const std::string & serverId, const std::string & sharedSecret,
