...
namespace util {
    ...
    bool Yggdrasil::JoinServer(const std::string &serverId, const std::string &sharedSecret,
    ...
    std::pair<std::string, std::string> Yggdrasil::Refresh(const std::string &accessToken,
