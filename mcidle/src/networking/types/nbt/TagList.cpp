...
void TagList::Push(s8 value) { m_Bytes.push_back(value); }

void TagList::Push(NBTString & value) { m_Strings.push_back(value); }

void TagList::Push(VarInt & value) { m_Ints.push_back(value); }

void TagList::Push(VarLong & value) { m_Longs.push_back(value); }

void TagList::Push(TagCompound value) { m_Tags.push_back(value); }
...
TagType TagList::ListType() const { return m_ListType; }

void TagList::SetListType(TagType type) { m_ListType = type; }
