...
EntityLookRelMove::EntityLookRelMove(VarInt EntityID, s16 DeltaX, s16 DeltaY, s16 DeltaZ, u8 Yaw, u8 Pitch, bool OnGround)
    : m_EntityID(EntityID), m_DeltaX(DeltaX), m_DeltaY(DeltaY), m_DeltaZ(DeltaZ), m_Yaw(Yaw), m_Pitch(Pitch), m_OnGround(OnGround)
{
}
