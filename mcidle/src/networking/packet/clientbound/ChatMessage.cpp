...
ChatMessage::ChatMessage(std::string data, s8 pos) :
	m_JsonData(data), m_Position(pos)
{
}

std::shared_ptr<Packet>
ChatMessage::Response(Protocol & protocol, s32 compression)
{
...
std::string ChatMessage::JsonData() const { return m_JsonData; }

Packet & ChatMessage::Serialize() { return *this; }
