...
PlayerPositionLook::PlayerPositionLook(double x, double y, double z, float yaw, float pitch, u8 flags, s32 teleportId) : m_X(x), m_Y(y), m_Z(z), m_Yaw(yaw), m_Pitch(pitch), m_Flags(flags), m_TeleportId(teleportId)
{
}
