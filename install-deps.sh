...
tar -xvf curl-7.61.0.tar.gz && cd curl-7.61.0 && ./configure --disable-shared --enable-static --prefix=/usr/curl --disable-sspi --disable-ftp --disable-file --disable-dict --disable-telnet --disable-tftp --disable-rtsp --disable-pop3 --disable-imap --disable-smtp --disable-gopher --disable-smb --with-ssl && make && make install && cd ..
